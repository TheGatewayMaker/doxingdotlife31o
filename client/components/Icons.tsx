...
export const DiscordIcon: React.FC<IconProps> = ({ className = "w-5 h-5" }) => (
  ...
  >
    {/* Discord blob shape */}
    <path d="M20.5 3.5C19.2 2.5 17.6 1.9 16 1.5c-.2 0-.4.1-.5.2-.1.2-.2.4-.3.7-.8 1.2-1.6 2.8-2.1 4 -1-.2-2.1-.3-3.1-.3s-2.1.1-3.1.3c-.5-1.2-1.3-2.8-2.1-4-.1-.3-.2-.5-.3-.7-.1-.1-.3-.2-.5-.2C6.4 1.9 4.8 2.5 3.5 3.5c-1.5 2.3-2.1 6.7-2 10.5 0 .1 0 .3.1.4 1.4 1.1 2.8 1.8 4.1 2.3.2.1.4 0 .5-.1.4-.6.8-1.2 1.2-1.9.2-.3.1-.6-.2-.7-.5-.2-1-.5-1.5-.7-.1-.1-.1-.2 0-.3.1-.1.3-.1.4-.1.8.3 1.7.6 2.5.9.2.1.4 0 .5-.1 1.5.7 3.1 1.1 4.7 1.1s3.2-.4 4.7-1.1c.1-.1.3 0 .5.1.8-.3 1.7-.6 2.5-.9.1 0 .3 0 .4.1.1.1.1.2 0 .3-.5.2-1 .5-1.5.7-.3.1-.4.4-.2.7.4.7.8 1.3 1.2 1.9.1.1.3.2.5.1 1.3-.5 2.7-1.2 4.1-2.3.1-.1.1-.3.1-.4.1-3.8-.5-8.2-2-10.5zM8 18c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5zm8 0c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z" />
  </svg>
);
